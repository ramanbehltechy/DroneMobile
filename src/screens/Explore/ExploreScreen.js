...
const ExploreScreen = () => {
  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
     <Header title={titleConstant.Explore} textStyle={{marginLeft:22}} onBackPress={handleBackPress}/>
    ...
    (<View style={styles.search_view}>
      ...
      />
       ...
       :(
        ...
        <Text style={{textAlign:'center',color:'white',fontFamily:fontFamily.fontFamily}}>No Results Found</Text>
        </View>
      )
      }
    </SafeAreaView>
